...
trackers.extend(trackerlist(name='stark_st', parameter_name='baseline_got10k_only', dataset_name=dataset_name,
                            run_ids=None, display_name='STARK-ST50_got10k_only'))
"""TransT"""
